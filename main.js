...
const reply_array = ['Well, if it isn\'t the famous tart Queen Cersei.', 'A sword swallower through and through.', 'Tell Cersei. I want her to know it was me.', 
		     ...
		     'The world is overflowing with horrible things, but they\'re all a tray of cakes next to death.', 'My grandson is the pride of Highgarden. The most desirable bachelor in all seven kingdoms. Your daughter is...old.', 'Are you here to seduce me?', 
		     'Oh, you can smell the shit from five miles away', 'I would have thought we were perfectly clear the first time. You\'re not welcome.', 'That is hardly your concern', 'Idiots, help your king.', 'Kiss me, child.', 'Speak freely, child. We would never betray your confidence, I swear it.',
		     'Speak freely, child. We would never betray your confidence, I swear it.', 'Ah. That\'s a pity.', 'Did you grow up with boy cousins, Lord Tywin? Sons of your father\'s bannermen, squires, stableboys', 'You love her. You really do love her. You poor fool. She\'ll be the end of you.'];
