...
const reply_array = ['Well, if it isn\'t the famous tart Queen Cersei.', 'A sword swallower through and through.', 'Tell Cersei. I want her to know it was me.', 
		     ...
		     'The world is overflowing with horrible things, but they\'re all a tray of cakes next to death.', 'My grandson is the pride of Highgarden. The most desirable bachelor in all seven kingdoms. Your daughter is...old.', 'Oh, you can smell the shit from five miles away', 
		     'I would have thought we were perfectly clear the first time. You\'re not welcome.', 'That is hardly your concern', 'Idiots, help your king.', 'Kiss me, child.', 'Speak freely, child. We would never betray your confidence, I swear it.',
